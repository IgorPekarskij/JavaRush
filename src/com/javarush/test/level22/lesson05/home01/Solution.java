...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) throws TooShortStringFirstThreadException, TooShortStringSecondThreadException{
        try{
            ...
            if (threadName.equals(FIRST_THREAD_NAME))
                throw new RuntimeException(new TooShortStringFirstThreadException(e));
            if (threadName.equals(SECOND_THREAD_NAME))
                throw new RuntimeException(new TooShortStringSecondThreadException(e));
            else
